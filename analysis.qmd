...
cor_result <- rcorr(as.matrix(constituents), type = "spearman")
p_matrix <- cor_result$P

# Create correlation plot
corrplot(cor_matrix, 
         method = "color",           # Fill tiles with colors
         type = "full",              # Show both upper and lower triangle
         col = COL2('RdBu', 200),    # Standard blue to red color scheme
         tl.col = "black",           # Text label color: black
         addCoef.col = "black",      # Coefficient text color: black
         addCoef = TRUE,             # Display correlation coefficients
